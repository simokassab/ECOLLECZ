...
class ExcelController extends Controller
{
    ...
    {
        if(is_file(storage_path('/imports/import.xlsx')))
        {
            unlink(storage_path('/imports/import.xlsx'));
        }
              ...
              && ($row['phone']!='961') && (strlen(trim($row['phone'])) <12) ){
                  //echo " COND: ".$row['phone']." - SIZE ".strlen(trim($row['phone']))."<br>";
                    ...
                    if(!$res) {
                        ...
                        'address'                  => '' ,
                        'created_at'                  => '2019-03-15 10:00:00' ,
                        'hash'                  => $hash
                        ];
                    $insert_data[] = $data;
                  }
        ...
        echo $this->j." new rows inserted successfully and ".$this->i." rows updated";
