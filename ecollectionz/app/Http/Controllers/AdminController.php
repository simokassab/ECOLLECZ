...
class AdminController extends Controller
{
    ...
    public function index()
    {
       ...
       // dd(DB::getQueryLog());
        ...
        $summary =  DB::select('SELECT count(B.id)as COUNT, status.name as STAT, B.status   FROM ( select client_name, phone, draft_no, 
        ...
        INNER JOIN status ON B.status =status.code GROUP BY status.name');
       // dd(DB::getQueryLog());
