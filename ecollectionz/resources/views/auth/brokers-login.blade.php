			...
			<div class="row" style="margin:0;">
				<div class="col-md-6 as" style="margin-top: 5%;" id="tofix">
					...
					<div class="wrap-select-arrow">
						<select class="active SignAs sel"  id="signin_b">
							...
							<option value="3"  class="SignAsOption"  selected="selected">Broker </option>
						</select>
				...
				<div class="col-md-6 to to1" id="SignIn" >
					<div class="contact text-left">
						<div class="mySlides1">
							<p class="signintitle" style="margin-bottom: 30px">Brokers Sign IN</p>
							@if (count($errors) > 0)
								...
								@endforeach
							@endif
							<form  class="form-horizontal form_re" method="POST" action="{{ route('brokers.login.submit') }}" 	>
							...
							<a   style="color: #A9A9A9; text-decoration: none; margin-left: 25%;" href="{{ route('broker.password.request') }}" >
								Forgot Password?
							</a>
