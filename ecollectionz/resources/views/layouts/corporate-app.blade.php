      ...
      <!-- Sidebar user panel (optional) -->
        <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="width: 100%; margin-top: 10%!important; border-bottom: 0px ;">
            ...
            <div class="image" style="padding-left: 20%!important; width: 100%!important;">
                ...
                <br><br>
                <a href="{{ route('corporates.profile') }}" id="profile"    style="margin-left: 8%!important;color:#FCD304; font-weight: bold; letter-spacing: 5px;">
                    PROFILE
                </a>
        ...
        "columns": [
                ...
                { "data": "comments",
                  "render": function (data, type, row, meta) {
                    ...
                    return '<a href="./'+comments+'/comments" class="btn btnclick" style="">Comments</a>';
