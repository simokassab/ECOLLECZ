                ...
                <tbody>
                  ...
                  @endif
                      ...
                      <td style="text-align:center;">
                        ...
                        @if ($a->active==1)
                            <a href="{{ route('admin.corporate.delete', $a->id) }}" class="btn" style="background-color: #a94442; color: white" title='Desactivate'>
                                <i class="fas fa-eye-slash"></i></a>
                        @else
                            <a href="{{ route('admin.corporate.activate', $a->id) }}" class="btn btn-success" title='Activate'>
                              <i class='fas fa-check-square'></i></a>
                        @endif
                          <a href="#" id="{{$a->id}}" class="btn btn-danger del_corp" title='Delete'>
