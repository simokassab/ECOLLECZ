...
<div class="content-wrapper">
  <!-- Modal-->
    ...
    <section class="content"> 
      <div class="container-fluid">
          <a class="btn btn-lg btn-success" style="float: right; color:white" data-toggle="modal" data-target="#myModalStatus"><i class="fas fa-plus"></i> Add New</a><br/><br/><br/>
        <div class="row">
                   ...
                   <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                          <td>{{$s->code}}</td>
                          <td>{{$s->name}}</td>
                          <td><a href="./{{$s->id}}/edit_status" class="btn btn-warning"><i class="fas fa-edit"></i> </a> </td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
