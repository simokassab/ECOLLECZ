...
<div class="wrapper">
  ...
  <aside class="main-sidebar " style="background-color: #1D3357 !important;">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="width: 100%; margin-top: 10%!important; border-bottom: 0px ;">
        ...
        ?>
          <img src="{{asset('images/') }}<?php echo '/'.$photo; ?>" class="img-circle " alt="User Image" style="width: 70%!important;  ">
            ...
            <br><br>
            <a href="{{ route('profile') }}"    style="margin-left: 8%!important;color:#FCD304; font-weight: bold; letter-spacing: 5px;">
                PROFILE
            </a>
      ...
      <nav class="mt-2">
        ...
        <a href="{{ route('logout') }}"  onclick="event.preventDefault();    
           ...
           style="margin-top: 8%!important; letter-spacing: 1px; width: 80%; height: 1%; margin-left: 7%; background-color: #FCD304!important; color:#021638;font-weight: bold;">
          &nbsp;LOGOUT
        </a>
