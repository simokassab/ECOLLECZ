...
<div class="wrapper" id="app">
   <div class="modal fade" id="myModal">
    ...
    <div class="modal fade" id="myModalStatus">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{route ('admin.status.save' )}}" method="post">
                <div class="modal-header" style="background-color: #012F5C; color: white;">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li  class='nav-item' >
          ...
          <li  class='nav-item' >
            <a href="{{ URL::route('admin.status') }}" class='nav-link'>
...
$(document).ready( function() {
  ...
  $('input[type="checkbox"].flat-red, input[type="radio"].flat-red').iCheck({
    ...
    $('.del_corp').click(function(event){
       event.preventDefault();
        var id = $(this).attr('id');
        var form_data = new FormData();
        form_data.append('id', id);
        var r = confirm("Are your sure you want to Delete this Corporate ? ");
        if (r == true) {
            $.ajax({
                url: "./corporate/"+id+"/deleteever",
                type        : 'get',
                ...
                error: function (response) {
                    alert('There is an error, please contact the support ! ');
                    location.reload();
                }
            });
        }
    ...
    $('.rclient_delete').click(function(event){
        event.preventDefault();
        var id = $(this).attr('id');
        var r = confirm("Are your sure you want to Delete this Corporate ? ");
        if (r == true) {
