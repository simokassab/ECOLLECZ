...
<div class="wrapper">
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                {!! Form::open(['action'=>'CorporateController@store', 'method'=>'POST', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col col-sm-6">
                            ...
                            <select class="form-control" name="brokers[]" id="brokers" multiple>
                                @foreach($brokers as $b)
                                    <option value="{{$b->bk_id}}">{{$b->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col col-sm-6">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2019 <a href="https://ecollectionz.com">Ecollectionz.com</a>.</strong>
    All rights reserved.
