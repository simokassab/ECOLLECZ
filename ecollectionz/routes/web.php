...
Route::get('/getSessionID', 'HomeController@getSessionID')->name('getsessionid');
...
Route::prefix('admin')->group(function() {
    ...
    Route::post('/status/save', 'Admins\StatusController@store')->name('admin.status.save');
    Route::get('/status', 'Admins\StatusController@index')->name('admin.status');
    Route::get('{id}/edit_status', 'Admins\StatusController@edit')->name('admin.edit.status');
    Route::post('/status/{id}/update', 'Admins\StatusController@update')->name('admin.status.update'); //this route only for updating the status
    ...
    Route::get('/corporate/{id}/deleteever', ['as' => 'admin.corporate.deleteever', 'uses' => 'Admins\AdminCpController@deleteEver']);
    ...
    Route::post('/brokgetdatatableers/{id}/update', 'Admins\AdminBrokersController@update')->name('admin.brokers.update'); //this route only for updating the corporate
    ...
    Route::get('{id}/delete', ['as' => 'admin.delete.client', 'uses' => 'Admins\ClientsController@delete']);
...
Route::prefix('corporate')->group(function() {
    Route::resource('/', 'CorporateController', ['only' => [ 'store']]);
...
Route::prefix('agents')->group(function() {
    Route::get('/login', 'Auth\AgentsLoginController@showLoginForm')->name('agents.login');
    Route::post('/login', 'Auth\AgentsLoginController@login')->name('agents.login.submit');
    Route::get('/', 'AgentsController@index')->name('agents.dashboard');
    Route::post('/logout', 'Auth\AgentsLoginController@logout')->name('agents.logout');
    Route::get('/clients', 'AgentsController@getClients')->name('agents.clients');
    Route::get('/{id}/status', ['as' => 'agents.getstatus', 'uses' => 'AgentsController@getPoliciesByStatus']);
    Route::post('/password/email', 'Auth\AgentsForgetPasswordController@sendResetLinkEmail')->name('agent.password.email');
    Route::get('/password/reset', 'Auth\AgentsForgetPasswordController@showLinkRequestForm')->name('agent.password.request');
    Route::post('/password/reset', 'Auth\AgentsResetPasswordController@reset');
    Route::get('/profile', 'AgentsController@getProfile')->name('agents.profile');
    Route::post('/updateprofile', 'AgentsController@updateProfile')->name('agents.profile.update');
    Route::get('/password/reset/{token}', 'Auth\AgentsResetPasswordController@showResetForm')->name('agent.password.reset');
    Route::get('/{id}/policies', ['as' => 'agents.policies', 'uses' => 'AgentsController@getPoliciesByClient']);
    Route::get('/allpolicies', ['as' => 'agents.allpolicies', 'uses' => 'AgentsController@getAllPolicies']);
    Route::get('/getdatatable',['as' => 'agents.getdatatable', 'uses' => 'AgentsController@getDatatable']);
    Route::get('/{id}/history', ['as' => 'agents.history', 'uses' => 'AgentsController@getHistory']);
    Route::get('/{id}/status', ['as' => 'agents.getstatus', 'uses' => 'AgentsController@getPoliciesByStatus']);
    Route::get('/{id}/comments', ['as' => 'agents.comments', 'uses' => 'AgentsController@getComments']);
    Route::post('/addreply', ['as' => 'agents.addreply', 'uses' => 'AgentsController@insertReply']);
    Route::get('/searchpolicies', ['as' => 'agents.searchpolicies', 'uses' => 'AgentsController@searchPolicies']);
    Route::get('/getsearch', ['as' => 'agents.getsearchget', 'uses' => 'AgentsController@searchPolicies']);
    Route::post('/getsearch', ['as' => 'agents.getsearch', 'uses' => 'AgentsController@getSearchPolicies']);
    Route::post('{id}/addcomment', ['as' => 'agents.addcomment', 'uses' => 'AgentsController@addComment']);
    Route::get('/requests', 'AgentsController@getRequests')->name('agents.requests');
    Route::get('/{id}/confirm', ['as' => 'brokerss.p_confirm', 'uses' => 'AgentsController@policyConfirm']);
    Route::get('/{id}/decline', ['as' => 'brokerss.p_decline', 'uses' => 'AgentsController@policyDecline']);

    //notifications

    Route::get('/notifications', 'AGNotificationsController@getNotifications')->name('agents.notifications');
    Route::get('{id}/read', 'AGNotificationsController@marAsRead')->name('agents.markread');
});
